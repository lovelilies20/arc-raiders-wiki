...
String get special => isRussian ? 'Специальное' : 'Special';
...
String get equaStory => isRussian ? 'Экспериментальная лучевая винтовка с большой ёмкостью.' : 'An experimental beam rifle with a large capacity.';
String get shots3450 => isRussian ? '3450 выстрелов' : '3450 shots fired';
String get ferroStory => isRussian ? 'Наносит мощный урон, но его нужно перезаряжать между каждым выстрелом.' : 'It deals powerful damage, but it needs to be reloaded between each shot.';
String get single => isRussian ? 'Одиночный' : 'Single';
String get hullStory => isRussian ? 'Стреляет взрывными снарядами, которые взрываются только при попадании в ARC.' : 'It fires explosive projectiles that only explode when they hit the ARC.';
String get hullShots => isRussian ? 'Боеприпасы для пусковой установки' : 'Ammunition for the launcher';
String get pompovi => isRussian ? 'Помповый' : 'Pump-type';
String get iltoroStory => isRussian ? 'У него большой разброс пуль, резкий спад и высокий урон.' : 'It has a wide bullet spread, a sharp decline, and high damage.';
String get patronDrobovik => isRussian ? 'Патроны для дробовика' : 'Shotgun Cartridges';
String get jupiterStory => isRussian ? 'Снайперская винтовка с затвором с исключительным уроном и точностью, но медленным управлением.' : 'A bolt-action sniper rifle with exceptional damage and accuracy, but slow control.';
String get shots167 => isRussian ? '167 выстрелов' : '167 shots fired';
String get zatvor => isRussian ? 'Скользящий затвор' : 'Sliding shutter';
String get kettleStory => isRussian ? 'Быстрый и точный, но с низкой скоростью пули и долго перезаряжается.' : 'It is fast and accurate, but has a slow bullet speed and takes a long time to reload.';
String get zum => isRussian ? 'Скоп (5,66x зум)' : 'Scope (5.66x zoom)';
String get rattlerStory => isRussian ? 'Дешёвый наступательный вариант, но его нужно перезаряжать по 2 пули за раз.' : 'It is a cheap offensive option, but it needs to be reloaded with two bullets at a time.';
String get buntarStory => isRussian ? 'Имеет высокий урон, точность и урон от выстрелов в голову.' : 'It has high damage, accuracy, and headshot damage.';
String get mechanism => isRussian ? 'Рычажный механизм' : 'Lever mechanism';
String get stitcherStory=> isRussian ? 'Наносит хороший урон, но имеет довольно низкую скорострельность и может быть трудно контролируемым.' : 'It deals good damage, but has a relatively low rate of fire and can be difficult to control.';
String get tempestStory => isRussian ? 'Умеренная скорострельность и точность.' : 'Moderate rate of fire and accuracy.';
String get torrenreStory => isRussian ? 'Имеет большой запас патронов, но точен только в приседе.' : 'It has a large ammo capacity, but it is only accurate when crouching.';
...
String get adrentt => isRussian ? 'Адреналин' : 'Adrenaline';
